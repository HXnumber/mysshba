...
//检验上传类型  (asx)|(asf)|(3gp)|(wmv)|(mp4)|(mov)|(avi)|(flv)|(wmv9)|(rm)|(rmvb)
//$.extend($.fn.validatebox.defaults.rules, {
//    isType : {  //：（，，，，，，，，,，，
//        validator: function(value,param){
//        	Regex reg = new Regex("^.+\.(asx)|(asf)|(3gp)|(wmv)|(mp4)|(mov)|(avi)|(flv)|(wmv9)|(rm)|(rmvb)$");
//        	return reg.Match(value.getUploadFileName.ToLower());
//        },
//        message: '视频格式有误，不是视频文件'
//    }
//});
